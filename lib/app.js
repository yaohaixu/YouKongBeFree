...
function createApp(options = {}) {
  ...
  app.get("/api/public/bootstrap", asyncRoute(async (req, res) => {
    const versions = await publicCacheVersions(["modules", "series", "friends", "activities:list", "miniprogram"], req);
    ...
    const basePayload = await cache.remember(
      ...
      async () => {
        ...
        const [modulesResult, series, friendsResult, upcoming, miniprogramConfig] = await Promise.all([
